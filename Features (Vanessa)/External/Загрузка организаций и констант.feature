...
@Описание: экспортный сценарий, который заполняет константы (защищенной аутентификации)
@ПримерИспользования: И Заполнение констант защищенной аутентификации
Сценарий: Заполнение констант защищенной аутентификации
