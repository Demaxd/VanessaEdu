...
* Заполнение ТЧ
	...
	И я перехожу к следующему реквизиту
	И в таблице 'Товары' в поле с именем 'ТоварыЦена' я ввожу текст "780,00"
	И я перехожу к следующему реквизиту
...
* Проверка ТЧ
	Тогда таблица 'Товары' стала равной:
		...
		| 'Ремонт'    | '1 500,00' | '3'           | '1 500,00' |
		| 'Босоножки' | '780,00'   | '4'          | '3 120,00' |
	И элемент формы с именем 'ТоварыИтогСумма' стал равен '4 620'
